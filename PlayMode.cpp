...
Load<MeshBuffer> hexapod_meshes(
...
PlayMode::PlayMode() : scene(*hexapod_scene)
{
	...
	for (auto &transform : scene.transforms)
	{
		...
		if (transform.name == "Hip.ML")
			hip_ml = &transform;
		else if (transform.name == "UpperLeg.ML")
			upper_leg_ml = &transform;
		else if (transform.name == "LowerLeg.ML")
			lower_leg_ml = &transform;
	}
	...
	hip_base_rotation_ml = hip_ml->rotation;
	upper_leg_base_rotation_ml = upper_leg_ml->rotation;
	lower_leg_base_rotation_ml = lower_leg_ml->rotation;
...
void PlayMode::update(float elapsed)
{
	...
	hip_ml->rotation = hip->rotation;
	upper_leg_ml->rotation = upper_leg->rotation;
	lower_leg_ml->rotation = lower_leg->rotation;
	// move camera:
	{
